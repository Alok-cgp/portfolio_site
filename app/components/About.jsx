  ...
  return (
    ...
    id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:0.8, delay: 0.6}}
        className='flex-1'>
            <p className='mb-10 max-w-2xl font-Ovo'>
                I am an experienced Frontend Developer with one year year of expertize in the field. Throughout my career, I have had the privilege of collaborating with prestigious companies, contributing to their success and growth. </p>

                <motion.ul initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:0, delay: 1}} 
