  ...
  return (
    ...
    id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
       I am a frontend developer from Kolkata, India. I create beautiful, fast and responsive websites that are easy to use and built with best practices.
      </motion.p>
      ...
      className='grid grid-cols-auto gap-6 my-10'>
        {serviceData.map(({icon, title, description, link},index)=>(
            ...
            key={index} className='border border-gray-400 rounded-lg px-8 py-12 hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white'>
                ...
                <p className='text-sm text-gray-600 leading-9 dark:text-white/80'>
                    {description}
                </p>
                <a className='flex items-center gap-2 text-sm mt-5 text-gray-700 dark:text-white' href={link}>
