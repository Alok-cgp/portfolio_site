      ...
      <motion.div initial={{scale: 0}} whileInView={{scale: 1}} transition={{duration: 0.8, type: 'spring', stiffness: 100}}>
        ...
        <motion.h3 initial={{y: -20, opacity: 0}} whileInView={{y: 0, opacity: 1}} transition={{duration: 0.6, delay: 0.3}}
         className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
            Hi! I'm Alok Kumar Shaw <Image src={assets.hand_icon} alt=''
            className='w-6' />
        </motion.h3>
        ...
        className='max-w-2xl mx-auto font-Ovo'>
            I am a Web developer, with a passion for creating beautiful, functional, and user-centered digital experiences.
        </motion.p>
