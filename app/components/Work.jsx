  ...
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
        Welcome to my web development portfolio! Explore a collection of projects showcasing my expertize in front-end development.
      </motion.p>
            ...
            className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group' key={index} style={{backgroundImage: `url(${bgImage})`}}>
                ...
                <div>
                    ...
                    <p className='text-sm text-gray-700'>{description}</p>
                     <a href={link} className='inline-flex items-center gap-1 font-semibold text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-300 relative group font-Ovo'>View</a>
                </div>
